...
let questions = [
  ...
  {
    question: "What is the color of the usb a type port in blue?",
  ...
  },
  {
    ...
    choice2: "You can run Windows with bootcamp.", // A program that supports the operating environment of Microsoft Windows on Mac.
    choice3: "There is a Mac App Store.", // It is a Mac App Store.
    choice4: "Mac os has a safari browser.", // This is the web browser built into macOS
    answer: 1
  },
  ...
  {
    question:
      "Choose one that is not compatible while making ryzen system",
